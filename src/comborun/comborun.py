...
if __name__== '__main__':
    ...
    for group in ps_data_ranges.keys():
        with h5py.File(f'{config.DATA_DIR}/{group}_peak_data.h5', "w") as f:
            print(group)
            cbr1 = ComboRun(generate_full_paths(ps_data_ranges[group], 25))
            cbr2 = ComboRun(generate_full_paths(ps_data_ranges[group], 7))
